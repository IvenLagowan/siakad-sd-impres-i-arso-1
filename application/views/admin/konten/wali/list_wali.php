              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td width="150">
                      <?php echo $b->NAMA_PENGAJAR ?>
                    </td>
                    <td>
                      <?php echo $b->NAMA_RUANG ?>
                    </td>
                    <td width="250">
                      <a href="<?php echo site_url('admin/Wali/edit/'.$b->ID_WALIKELAS) ?>"
                       class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
          <a onclick="deleteConfirm('<?php echo site_url('admin/Wali/delete/'.$b->ID_WALIKELAS) ?>')"
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
               <form action="<?php echo site_url('admin/Wali') ?>" method="post" enctype="multipart/form-data" >
              ...
              <select class="custom-select <?php echo form_error('ID_PENGAJAR') ? 'is-invalid':'' ?>" name="ID_PENGAJAR"> 
                  ...
                  <option value="<?php echo $s->ID_PENGAJAR?>"><?php echo $s->NAMA_PENGAJAR ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
              ...
              <select class="custom-select <?php echo form_error('ID_RUANG') ? 'is-invalid':'' ?>" name="ID_RUANG"> 
                  <?php foreach ($ruang as $s2): ?>
                  <option value="<?php echo $s2->ID_RUANG?>"><?php echo $s2->NAMA_RUANG ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
